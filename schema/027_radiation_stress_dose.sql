...
CREATE TABLE IF NOT EXISTS device_material_layers (
    ...
    net_doping_cm3             DOUBLE PRECISION,
    net_doping_basis           TEXT,
    ...
    CHECK (net_doping_cm3 IS NULL OR net_doping_cm3 > 0.0),
...
ALTER TABLE device_material_layers
    ...
    ADD COLUMN IF NOT EXISTS net_doping_cm3 DOUBLE PRECISION,
    ADD COLUMN IF NOT EXISTS net_doping_basis TEXT,
