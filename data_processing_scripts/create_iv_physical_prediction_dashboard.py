#!/usr/bin/env python3
"""
Create the "Post-IV Physical Prediction Validation Diagnostics" dashboard in Apache
Superset.
...
def main():
    print("Creating Post-IV Physical Prediction Validation Diagnostics dashboard\n" + "=" * 62)
